      ...
      <div className="p-8 flex flex-col items-center">
        ...
        <div className="w-full space-y-3">
          ...
          <form onSubmit={handleEmailLogin} className="mt-4 space-y-3">
            {errorMsg ? <p className="text-center text-sm font-medium text-red-500">{errorMsg}</p> : null}
            <input
              type="email"
              value={email}
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-lime-500/20 hover:bg-lime-500/30 text-lime-500 text-sm font-bold py-3 rounded-xl transition-colors disabled:opacity-50"
            >
              Continuar com Email
            </button>
          </form>
        ...
        <div className="flex gap-4 mb-8">
          <button 
            disabled={isLoading}
            className="w-12 h-12 bg-[#1e1e1e] rounded-xl border border-[#2a2a2a] flex items-center justify-center opacity-50 cursor-not-allowed"
          >
