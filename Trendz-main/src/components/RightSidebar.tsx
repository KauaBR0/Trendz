...
export function RightSidebar() {
  ...
  const handlePlaceBet = () => {
    ...
    // Supondo que você salvará a aposta no Supabase depois, 
    // por enquanto mockamos no placeBet com o balance.
    placeBet(numAmount, profile.balance);
  };

  return (
    <aside className="w-full bg-[#1e1e1e] border border-[#2a2a2a] rounded-2xl flex flex-col h-[70vh] min-h-[500px] sticky top-0 overflow-hidden shadow-xl">
            ...
            {!selectedBet ? (
              ...
              <div className="space-y-4 flex-1">
                ...
                <button 
                  ...
                  disabled={!user || numAmount <= 0 || (profile && profile.balance < numAmount)}
