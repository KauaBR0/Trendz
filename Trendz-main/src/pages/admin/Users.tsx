...
export function AdminUsers() {
  ...
  const mockUsers = [
    profile,
    { id: 'u2', name: 'Maria Silva', email: 'maria@example.com', avatar_url: 'https://picsum.photos/seed/maria/100/100', balance: 450.50, role: 'user' },
    { id: 'u3', name: 'Carlos Santos', email: 'carlos@example.com', avatar_url: 'https://picsum.photos/seed/carlos/100/100', balance: 12.00, role: 'user' },
    { id: 'u4', name: 'Ana Oliveira', email: 'ana@example.com', avatar_url: 'https://picsum.photos/seed/ana/100/100', balance: 8900.00, role: 'user' },
